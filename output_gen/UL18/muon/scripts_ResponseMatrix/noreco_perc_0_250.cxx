...
void noreco_perc_0_250() {

    TFile *file1 = TFile::Open("semi.root");
    // TFile *file2 = TFile::Open("other.root");

    const char* folderNames[] = {
        "DY_Match_N_N_0_250_muon_General", "DY_Match_N_P_0_250_muon_General",
        "DY_Match_P_N_0_250_muon_General", "DY_Match_P_P_0_250_muon_General",
        "DY_Mass_0_250_NOT_reco_muon_General"
    };
    ...
    double unmatchedPercentage = (1 / ) * 100;
