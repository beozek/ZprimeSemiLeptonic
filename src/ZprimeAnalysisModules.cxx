...
ZprimeAnalysisModule::ZprimeAnalysisModule(uhh2::Context& ctx){
  ...
  h_DeltaY_N_gen_ele = ctx.declare_event_output<float> ("DeltaY_N_gen"); //-beren DeltaY
  h_DeltaY_N_gen_muon = ctx.declare_event_output<float> ("DeltaY_N_gen"); //-beren DeltaY
  ...
  h_DeltaY_P_gen_ele = ctx.declare_event_output<float> ("DeltaY_P_gen"); //-beren DeltaY
  h_DeltaY_P_gen_muon = ctx.declare_event_output<float> ("DeltaY_P_gen"); //-beren DeltaY
  ...
  vector<string> histogram_tags = {"Muon1_LowPt", "Muon1_HighPt", "Muon1_Tot", "Ele1_LowPt", "Ele1_HighPt", "Ele1_Tot", "TriggerMuon", "TriggerEle", "TwoDCut_Muon", "TwoDCut_Ele", "Jet1", "Jet2", "MET"};
 ...
 if(debug) cout<<" run.event: "<<event.run<<". "<<event.event<<endl;
  ...
  if(isMuon){
   ...
   //-beren
      ...
      // cout << "Size of genparticle vector: " << genparticle.size() << endl; 
