...
void noreco_perc_750_900() {

    TFile *file1 = TFile::Open("semi.root");
    // TFile *file2 = TFile::Open("other.root");

    const char* folderNames[] = {
        "DY_Match_N_N_750_900_muon_General", "DY_Match_N_P_750_900_muon_General",
        "DY_Match_P_N_750_900_muon_General", "DY_Match_P_P_750_900_muon_General",
        "DY_Mass_750_900_NOT_reco_muon_General"
    };
    ...
    double unmatchedPercentage = (78534/ 79129) * 100;
