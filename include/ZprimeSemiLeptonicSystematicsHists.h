...
protected:
  ...
  uhh2::Event::Handle<float> h_ttbar_ewk_nominal;
  uhh2::Event::Handle<float> h_ttbar_ewk_up;
  uhh2::Event::Handle<float> h_ttbar_ewk_down;
  //QCD uncertainty: up = no NNLO QCD correction, down = mirror around nominal.
  uhh2::Event::Handle<float> h_ttbar_nnlo_qcd_nominal;
  uhh2::Event::Handle<float> h_ttbar_nnlo_qcd_up;
  uhh2::Event::Handle<float> h_ttbar_nnlo_qcd_down;
  ...
  TH1F *DeltaY_ewk_up;
  TH1F *DeltaY_ewk_down;
  //QCD uncertainty: up = no NNLO QCD correction, down = mirror around nominal.
  TH1F *DeltaY_qcd_up;
  TH1F *DeltaY_qcd_down;
  ...
  TH1F *DeltaY_xi_reco_6_ewk_up;           TH1F *DeltaY_xi_reco_6_ewk_down;
  //QCD uncertainty: up = no NNLO QCD correction, down = mirror around nominal.
  TH1F *DeltaY_xi_reco_6_qcd_up;           TH1F *DeltaY_xi_reco_6_qcd_down;
  ...
  //3jets
  TH2F *Mtt_reco_vs_gen_resolved;
  TH2F *Mtt_reco_vs_gen_resolved_ge3ak4;
  TH2F *Mtt_reco_vs_gen_resolved_ge3ak4_analysis;
  TH2F *Mtt_reco_vs_gen_matched;
  TH2F *response_matrix;
  TH1F *DeltaY_xi_reco_unw;
  ...
  TH2F *DeltaY_ewk_up_tt;
  TH2F *DeltaY_ewk_down_tt;
  //QCD uncertainty: up = no NNLO QCD correction, down = mirror around nominal.
  TH2F *DeltaY_qcd_up_tt;
  TH2F *DeltaY_qcd_down_tt;
