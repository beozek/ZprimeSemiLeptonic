...
file = ROOT.TFile.Open("Semileptonic_folder_gen.root")

dirs = ["Gen_ele_N_General", "Ele_N_Pt_General", "Ele_N_Pt_Eta_General", "Ele_N_JetPt_General", "Ele_N_JetPt_Eta_General"]


# Create histograms for each branch
hist1 = ROOT.TH1F("hist1", "DeltaY_N_gen_ele", 1, -2, 2)
hist2 = ROOT.TH1F("hist2", "DeltaY_N_gen_ele_pt", 1, -2, 2)
hist3 = ROOT.TH1F("hist3", "DeltaY_N_gen_ele_pt_eta", 1, -2, 2)
hist4 = ROOT.TH1F("hist4", "DeltaY_N_gen_ele_jetpt", 1, -2, 2)
hist5 = ROOT.TH1F("hist5", "DeltaY_N_gen_ele_jetpteta", 1, -2, 2)
