...
Sensor=args.sensor; thr_data_file='/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/SH0016/Run000011_SCurve.root'
# Path where the results will be stored
Path='results_xray/'
# Path to the NoiseScan root file (PixelAlive for us)
analyzed_data_file='/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/SH0016/Run000001_NoiseScan.root'; 
# Path to the .txt file that contains sensor information
analyzed_txt_file ='/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/SH0016/Run000011_ROC12.txt'
...
def XRayAnalysis(nTrg,nBX):
    ...
    print("Missing Pixels (column, row):")
