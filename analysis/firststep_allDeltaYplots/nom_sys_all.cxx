...
int nom_sys_all() {
    std::vector<std::pair<std::string, std::string>> inputOutputFiles = {
        {"/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Zprime_Analysis_UL18_muon_combine_latest/DATA/nominal/uhh2.AnalysisModuleRunner.DATA.root", "dY_UL18_muon_750_900_DATA.root"},
        {"/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Zprime_Analysis_UL18_muon_combine_latest/WJets/nominal/uhh2.AnalysisModuleRunner.WJets.root", "dY_UL18_muon_750_900_WJets.root"},
        {"/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Zprime_Analysis_UL18_muon_combine_latest/DY/nominal/uhh2.AnalysisModuleRunner.DY.root", "dY_UL18_muon_750_900_DY.root"},
        {"/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Zprime_Analysis_UL18_muon_combine_latest/Diboson/nominal/uhh2.AnalysisModuleRunner.Diboson.root", "dY_UL18_muon_750_900_Diboson.root"},
        {"/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Zprime_Analysis_UL18_muon_combine_latest/ST/nominal/uhh2.AnalysisModuleRunner.ST.root", "dY_UL18_muon_750_900_ST.root"},
        {"/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Zprime_Analysis_UL18_muon_combine_latest/QCD/nominal/uhh2.AnalysisModuleRunner.QCD.root", "dY_UL18_muon_750_900_QCD.root"},
    };

    for (const auto &inputOutputPair : inputOutputFiles) {
        std::cout << "Processing input file: " << inputOutputPair.first << std::endl;
        processFile(inputOutputPair.first, inputOutputPair.second);
    }
