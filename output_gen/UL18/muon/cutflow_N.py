...
file = ROOT.TFile.Open("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_gen/UL18/muon/workdir_Analysis_UL18_muon_gen/nominal/uhh2.AnalysisModuleRunner.Semileptonic1.root")
...
print("UL18 muon -> Number of events with lepton_pt & eta & jet pteta cut : {}".format(hist4.Integral()))

        
# Create a new histogram with 3 bins
summary_hist = ROOT.TH1F("summary_hist", "UL18 muon DeltaY < 0", 4, 0, 4)
...
summary_hist.GetXaxis().SetBinLabel(3, "Lepton Pt&Eta and Jet Pt&Eta")
