...
----------------------------------------------------------------------------------------------------------------------------------
shapes data_obs     {lepton}_{year}_{mass_range}_SR      /nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/analysis/newmatching/UL18/combine_input/combined_regions/dY_{year}_{lepton}_{mass_range}_SR.root SR/data_obs
shapes *            {lepton}_{year}_{mass_range}_SR      /nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/analysis/newmatching/UL18/combine_input/combined_regions/dY_{year}_{lepton}_{mass_range}_SR.root SR/$PROCESS SR/$PROCESS_$SYSTEMATIC
shapes data_obs     {lepton}_{year}_{mass_range}_CR1     /nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/analysis/newmatching/UL18/combine_input/combined_regions/dY_{year}_{lepton}_{mass_range}_CR1.root CR1/data_obs
shapes *            {lepton}_{year}_{mass_range}_CR1     /nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/analysis/newmatching/UL18/combine_input/combined_regions/dY_{year}_{lepton}_{mass_range}_CR1.root CR1/$PROCESS CR1/$PROCESS_$SYSTEMATIC
shapes data_obs     {lepton}_{year}_{mass_range}_CR2     /nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/analysis/newmatching/UL18/combine_input/combined_regions/dY_{year}_{lepton}_{mass_range}_CR2.root CR2/data_obs
shapes *            {lepton}_{year}_{mass_range}_CR2     /nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/analysis/newmatching/UL18/combine_input/combined_regions/dY_{year}_{lepton}_{mass_range}_CR2.root CR2/$PROCESS CR2/$PROCESS_$SYSTEMATIC
----------------------------------------------------------------------------------------------------------------------------------
