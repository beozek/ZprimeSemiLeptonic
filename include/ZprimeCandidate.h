...
public:
  ...
  bool is_wtag_reconstruction() const{return m_is_wtag_reconstruction;} //-beren wtag
  ...
  void set_is_wtag_reconstruction(bool x) {m_is_wtag_reconstruction=x;} //-beren wtag
