...
protected:
  ...
  TH1F *DeltaY, *DeltaY_ele, *DeltaY_muon, *DeltaY_N, *DeltaY_P, *DeltaY_N_ele, *DeltaY_N_muon, *DeltaY_P_ele, *DeltaY_P_muon, *M_ttbar_750Inf, *M_ttbar_750_900, *M_ttbar_900Inf, *M_ttbar, *M_top, *M_antitop, *Pt_ttbar, *Pt_top, *Pt_antitop, *Eta_ttbar, *Eta_top, *Eta_antitop; //-beren # of events gen info
