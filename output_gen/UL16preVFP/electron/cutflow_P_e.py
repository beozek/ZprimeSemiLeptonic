...
print("UL16preVFP ele -> Number of events with lepton_pt & eta & jet pteta cut : {}".format(hist4.Integral()))      
# Create a new histogram with 3 bins
summary_hist = ROOT.TH1F("summary_hist", "UL16preVFP ele DeltaY > 0", 4, 0, 4)
