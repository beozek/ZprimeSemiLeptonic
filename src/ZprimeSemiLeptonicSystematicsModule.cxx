...
ZprimeSemiLeptonicSystematicsModule::ZprimeSemiLeptonicSystematicsModule(Context& ctx){
  ...
  v_systs = {"pu", "prefiring", "mu_id_stat", "mu_id_syst", "mu_iso_stat", "mu_iso_syst", "mu_reco", "mu_trigger_stat","mu_trigger_syst", "ele_id", "ele_reco", "ele_trigger", "btag_cferr1", "btag_cferr2", "btag_hf", "btag_hfstats1", "btag_hfstats2", "btag_lf", "btag_lfstats1", "btag_lfstats2", "ttag_corr", "ttag_uncorr", "tmistag", "ewk"};
  v_syst_handlenames = {"weight_pu", "prefiringWeight", "weight_sfmu_id_stat","weight_sfmu_id_syst", "weight_sfmu_iso_stat","weight_sfmu_iso_syst", "weight_sfmu_reco", "weight_sfmu_trigger_stat","weight_sfmu_trigger_syst", "weight_sfelec_id", "weight_sfelec_reco", "weight_sfelec_trigger", "weight_btagdisc_cferr1", "weight_btagdisc_cferr2", "weight_btagdisc_hf", "weight_btagdisc_hfstats1", "weight_btagdisc_hfstats2", "weight_btagdisc_lf", "weight_btagdisc_lfstats1", "weight_btagdisc_lfstats2", "weight_toptagsf_corr", "weight_toptagsf_uncorr", "weight_topmistagsf", "weight_ttbar_ewk"};
  v_psscales = {"isr", "fsr"};
  ...
  for(unsigned int i=0; i<v_systs.size(); ++i){
    for(unsigned int j=0; j<v_variations.size(); ++j){
      ...
      else if(v_systs[i] == "ewk"){ // ttbar EWK correction stores explicit nominal/up/down branch names
        handlename_nominal = "weight_ttbar_ewk_nominal";
        handlename_shift = TString("weight_ttbar_ewk_") + v_variations[j];
      }
